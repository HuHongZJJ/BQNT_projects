...
class Application:
    ...
    def _build_datagrid(self,data,column_size=200) :
        ...
        renderers = {
            ...
            'trailing 1q performance':TextRenderer(format='.2%', background_color = ColorScale(min =  min(data["trailing 1q performance"]), mid = self._find_middle(data["trailing 1q performance"]), max = max(data["trailing 1q performance"]), dtype = "percentile"), scheme = "RdWtGn", text_color = 'black'),
            'div indicated':TextRenderer(format='.2f', background_color = ColorScale(min =  min(data["div indicated"]), max = max(data["div indicated"])), scheme = "RdYlGn", text_color = 'black'),
            '12-month yield':TextRenderer(format='.2%', background_color = ColorScale(min =  min(data["12-month yield"]), max = max(data["12-month yield"]), dtype = "percentile"), scheme = "RdYlGn", text_color = 'black'),
            '3-year dividend growth':TextRenderer(format='.2%', background_color = ColorScale(min =  min(data["3-year dividend growth"]), max = max(data["3-year dividend growth"]), dtype = "percentile"), scheme = "RdYlGn", text_color = 'black'),
            'current premium/ discount':TextRenderer(format='.2%', background_color = ColorScale(min =  min(data["current premium/ discount"]), mid = 0, max = max(data["current premium/ discount"]), dtype = "percentile"), scheme = "RdWtGn", text_color = 'black'),
            '1-year Zscore NAV premium':TextRenderer(format='.2f', background_color = ColorScale(min =  min(data["1-year Zscore NAV premium"]), mid = 0, max = max(data["1-year Zscore NAV premium"])), scheme = "RdWtGn", text_color = 'black'),
            '90-day Zscore':TextRenderer(format='.2f', background_color = ColorScale(min =  min(data["90-day Zscore"]), mid  = 0, max = max(data["90-day Zscore"])), scheme = "RdWtGn", text_color = 'black'),
            '5-year NAV std':TextRenderer(format='.2%', background_color = ColorScale(min =  min(data["5-year NAV std"]), max = max(data["5-year NAV std"]), dtype = "percentile"), scheme = "RdYlGn", text_color = 'black'),
            "max drawdown":TextRenderer(format='.2%', background_color = ColorScale(min =  min(data["max drawdown"]), max = max(data["max drawdown"]), dtype = "percentile"), scheme = "RdYlGn", text_color = 'black'),
            '5-year NAV return':TextRenderer(format='.2%', background_color = ColorScale(min =  min(data["5-year NAV return"]), mid = 0, max = max(data["5-year NAV return"]), dtype = "percentile"), scheme = "RdWtGn", text_color = 'black'),
            'current market cap (millions)':TextRenderer(format='$.2f'),
            'assuming 400k trade':TextRenderer(format='.2%', background_color = ColorScale(min =  min(data["div indicated"]), max = max(data["div indicated"])), scheme = "RdWtGn", text_color = 'black'),
        }
